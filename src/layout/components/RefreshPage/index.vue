<template>
  <div id="i-layout-navbar-refresh" class="i-layout-navbar-refresh" @click="handleRefresh">
    <svg class="refresh" viewBox="0 0 1024 1024" xmlns="http://www.w3.org/2000/svg" width="64" height="64">
      <path
